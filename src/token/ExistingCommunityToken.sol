...
import { ExistingCommunityStorage } from "./storage/ExistingCommunityStorage.sol";
...
contract ExistingCommunityToken is IToken, UUPS, Ownable, ReentrancyGuard, ERC721Votes, ExistingCommunityStorage {
    ///                                                          ///
    ///                         IMMUTABLES                       ///
    ///                                                          ///
    ...
    function mint() external nonReentrant returns (uint256 tokenId) {
        ...
        unchecked {
            do {
                ...
                tokenId = auctionOffset + settings.mintCount++;
